package com.github.amazingredstonemusic.blocks;
...
public class BlueRepeaterBlock extends AbstractRedstoneGateBlock {
    public static final BooleanProperty LOCKED;
    public static final IntProperty DELAY;

    public BlueRepeaterBlock(AbstractBlock.Settings settings) {
        super(settings);
